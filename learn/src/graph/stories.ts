...
export const R2_TO_MOTORS_STORY: Story = {
  ...
  steps: [
    ...
    { nodeId: 'safe-state', example: { state: 'SAFE_STATE', armed: false } },
    { nodeId: 'safe-baseline', example: { sessionReady: true } },
    { nodeId: 'message-ordering', example: { lastSeq: 381 } },
    { nodeId: 'ttl-watchdog', example: { ttlMs: 500, heartbeatMs: 150 } },
    { nodeId: 'emergency-stop', example: { type: 'emergency-stop' } },
